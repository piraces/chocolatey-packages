...
-Url 'https://github.com/achannarasappa/ticker/releases/download/v2.1.0/ticker-2.1.0-windows-386.tar.gz' `
-Url64bit 'https://github.com/achannarasappa/ticker/releases/download/v2.1.0/ticker-2.1.0-windows-amd64.tar.gz'
